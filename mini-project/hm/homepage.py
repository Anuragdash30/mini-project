...
def ua_frame():
    ...
    ua5=Label(ua_frame,text='Ms.Anushree Rege , Mr.Anurag Dash , Mr.Harmeet Singh & Ms.Sakshi Jetley.',bg="black",borderwidth=0,fg='thistle',font=("Comic Sans MS",14))
...
def goa_frame():
    ...
    go6=Label(goa_frame,bg="black",borderwidth=0,text="Hotel : ",fg='lightgreen',font=("Comic Sans MS",14))
    go6.place(relx =0.47, rely = 0.75)
    ...
    g_entry1 = Spinbox(goa_frame, from_=1, to=6,font=("Comic Sans MS",12), width=3,justify=CENTER)
    g_entry1.place(relx =0.67, rely = 0.64)

    g_entry2 = Entry(goa_frame,font=("Comic Sans MS",12),width=12,state=DISABLED)
    g_entry2.place(relx =0.71, rely = 0.87)
    
    g_tt = Button(goa_frame,text='Book Now',bg="thistle",fg='black',borderwidth=2,font=("Comic Sans MS",12))
    g_tt.place(relx =0.88, rely = 0.86)

    gv = IntVar()

    g_rad1=Radiobutton(goa_frame,text="2 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=gv,value=1,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.56, rely = 0.75)
    g_rad2=Radiobutton(goa_frame,text="3 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=gv,value=2,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.66, rely = 0.75)
    g_rad3=Radiobutton(goa_frame,text="4 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=gv,value=3,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.76, rely = 0.75)
    g_rad4=Radiobutton(goa_frame,text="5 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=gv,value=4,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.86, rely = 0.75)
...
def raj_frame():
    ...
    ra6=Label(raj_frame,bg="black",borderwidth=0,text="Hotel : ",fg='lightgreen',font=("Comic Sans MS",14))
    ra6.place(relx =0.47, rely = 0.75)
    ...
    r_entry1 = Spinbox(raj_frame, from_=1, to=6,font=("Comic Sans MS",12), width=3,justify=CENTER)
    r_entry1.place(relx =0.67, rely = 0.64)

    r_entry2 = Entry(raj_frame,font=("Comic Sans MS",12),width=12,state=DISABLED)
    r_entry2.place(relx =0.71, rely = 0.87)
    
    r_tt = Button(raj_frame,text='Book Now',bg="thistle",fg='black',borderwidth=2,font=("Comic Sans MS",12))
    r_tt.place(relx =0.88, rely = 0.86)

    rv = IntVar()

    r_rad1=Radiobutton(raj_frame,text="2 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=rv,value=1,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.56, rely = 0.75)
    r_rad2=Radiobutton(raj_frame,text="3 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=rv,value=2,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.66, rely = 0.75)
    r_rad3=Radiobutton(raj_frame,text="4 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=rv,value=3,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.76, rely = 0.75)
...
def ker_frame():
    ...
    ker6=Label(ker_frame,bg="black",borderwidth=0,text="Hotel : ",fg='lightgreen',font=("Comic Sans MS",14))
    ker6.place(relx =0.47, rely = 0.75)
    ...
    k_entry1 = Spinbox(ker_frame, from_=1, to=6,font=("Comic Sans MS",12), width=3,justify=CENTER)
    k_entry1.place(relx =0.67, rely = 0.64)

    k_entry2 = Entry(ker_frame,font=("Comic Sans MS",12),width=12,state=DISABLED)
    k_entry2.place(relx =0.71, rely = 0.87)
    
    k_tt = Button(ker_frame,text='Book Now',bg="thistle",fg='black',borderwidth=2,font=("Comic Sans MS",12))
    k_tt.place(relx =0.88, rely = 0.86)

    kv = IntVar()

    k_rad1=Radiobutton(ker_frame,text="2 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=kv,value=1,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.56, rely = 0.75)
    k_rad2=Radiobutton(ker_frame,text="3 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=kv,value=2,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.66, rely = 0.75)
    k_rad3=Radiobutton(ker_frame,text="4 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=kv,value=3,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.76, rely = 0.75)
    k_rad4=Radiobutton(ker_frame,text="5 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=kv,value=4,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.86, rely = 0.75)
...
def mala_frame():
    ...
    mala6=Label(mala_frame,bg="black",borderwidth=0,text="Hotel : ",fg='lightgreen',font=("Comic Sans MS",14))
    mala6.place(relx =0.47, rely = 0.75)
    ...
    m_entry1 = Spinbox(mala_frame, from_=1, to=6,font=("Comic Sans MS",12), width=3,justify=CENTER)
    m_entry1.place(relx =0.67, rely = 0.64)

    m_entry2 = Entry(mala_frame,font=("Comic Sans MS",12),width=12,state=DISABLED)
    m_entry2.place(relx =0.71, rely = 0.87)
    
    m_tt = Button(mala_frame,text='Book Now',bg="thistle",fg='black',borderwidth=2,font=("Comic Sans MS",12))
    m_tt.place(relx =0.88, rely = 0.86)

    mv = IntVar()

    m_rad1=Radiobutton(mala_frame,text="2 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=mv,value=1,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.56, rely = 0.75)
    m_rad2=Radiobutton(mala_frame,text="3 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=mv,value=2,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.66, rely = 0.75)
    m_rad3=Radiobutton(mala_frame,text="4 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=mv,value=3,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.76, rely = 0.75)
...
def au_frame():
    ...
    au6=Label(au_frame,bg="black",borderwidth=0,text="Hotel : ",fg='lightgreen',font=("Comic Sans MS",14))
    au6.place(relx =0.47, rely = 0.75)
    ...
    a_entry1 = Spinbox(au_frame, from_=1, to=6,font=("Comic Sans MS",12), width=3,justify=CENTER)
    a_entry1.place(relx =0.67, rely = 0.64)

    a_entry2 = Entry(au_frame,font=("Comic Sans MS",12),width=12,state=DISABLED)
    a_entry2.place(relx =0.71, rely = 0.87)
    
    a_tt = Button(au_frame,text='Book Now',bg="thistle",fg='black',borderwidth=2,font=("Comic Sans MS",12))
    a_tt.place(relx =0.88, rely = 0.86)

    av = IntVar()

    a_rad1=Radiobutton(au_frame,text="2 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=av,value=1,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.56, rely = 0.75)
    a_rad2=Radiobutton(au_frame,text="3 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=av,value=2,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.66, rely = 0.75)
    a_rad3=Radiobutton(au_frame,text="4 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=av,value=3,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.76, rely = 0.75)
    a_rad4=Radiobutton(au_frame,text="5 Star",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',variable=av,value=4,bg="black",borderwidth=0,font=("Comic Sans MS",14)).place(relx =0.86, rely = 0.75)
...
def nada_frame():
    ...
    nada6=Label(nada_frame,bg="black",borderwidth=0,text="Hotel : ",fg='lightgreen',font=("Comic Sans MS",14))
    nada6.place(relx =0.47, rely = 0.75)
    ...
    n_entry1 = Spinbox(nada_frame, from_=1, to=6,font=("Comic Sans MS",12), width=3,justify=CENTER)
    n_entry1.place(relx =0.67, rely = 0.64)

    n_entry2 = Entry(nada_frame,font=("Comic Sans MS",12),width=12,state=DISABLED)
    n_entry2.place(relx =0.71, rely = 0.87)
    
    n_tt = Button(nada_frame,text='Book Now',bg="thistle",fg='black',borderwidth=2,font=("Comic Sans MS",12))
    n_tt.place(relx =0.88, rely = 0.86)
    
    nv = IntVar()

    n_rad1=Radiobutton(nada_frame,bg="black",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',text="2 Star",variable=nv,value=1,font=("Comic Sans MS",14)).place(relx =0.56, rely = 0.75)
    n_rad2=Radiobutton(nada_frame,bg="black",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',text="3 Star",variable=nv,value=2,font=("Comic Sans MS",14)).place(relx =0.66, rely = 0.75)
    n_rad3=Radiobutton(nada_frame,bg="black",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',text="4 Star",variable=nv,value=3,font=("Comic Sans MS",14)).place(relx =0.76, rely = 0.75)
    n_rad4=Radiobutton(nada_frame,bg="black",selectcolor='maroon',activebackground="black",activeforeground="white",fg='white',text="5 Star",variable=nv,value=4,font=("Comic Sans MS",14)).place(relx =0.86, rely = 0.75)
...
btn4 = tk.Radiobutton(root,text = "Login",padx=5,selectcolor='gray25',indicator=0,variable=hellov,value=4,bg="black",fg='white',font=("Lucida Calligraphy",12,"bold"),borderwidth=0,activebackground='gray25',activeforeground='white')
